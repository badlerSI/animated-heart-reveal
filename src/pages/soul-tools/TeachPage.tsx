...
const config: SoulAppConfig = {
  ...
  primary: "#8B5CF6",
  accent: "#A78BFA",
  tagline: "Teaching just got a superpower upgrade. 🦸‍♀️",
  connectionMessage:
    "Hold up — you're not connected to the school server! SOUL Teach runs entirely on your school's local network for maximum privacy. Hop on the school WiFi and come back!",
  MainIcon: Shield,
  features: [
