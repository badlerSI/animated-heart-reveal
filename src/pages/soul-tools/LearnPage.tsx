...
const config: SoulAppConfig = {
  ...
  connectionMessage:
    "Looks like you're not on your school's network! SOUL Learn lives on your school's local server — like a secret library that only works on campus. Connect to your school WiFi and try again!",
  MainIcon: Brain,
  features: [
    ...
    { icon: FileText, title: "Smart Notes", description: "Take notes that actually organize themselves. AI helps summarize, highlight key concepts, and connect ideas." },
