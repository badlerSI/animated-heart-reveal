...
const config: SoulAppConfig = {
  ...
  connectionMessage:
    "Whoa there, Picasso. You need to be on your school network to use SOUL Creator. All the AI magic happens on your school's local server. No internet needed, no data leaving campus. Connect to WiFi and let's make something awesome.",
  MainIcon: Palette,
  features: [
