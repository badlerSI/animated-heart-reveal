...
export default function HeartNavigation() {
  ...
  return (
    <div className="w-full px-4 py-12 flex justify-center">
      {/* exactly your container */}
      <div className="relative w-80 h-80 md:w-96 md:h-96">
        
        {/* your four overlapping images */}
        <img
        ...
        {/* SVG overlay with rotated hit‐paths */}
        <svg
          viewBox="0 0 400 400"
        ...
        >
          {/* News path, rotated −15° around center (200,200) */}
          <path
