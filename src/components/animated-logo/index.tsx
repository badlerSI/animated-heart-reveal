...
const AnimatedLogo = () => {
  ...
  const imagesToPreload = [
    "/lovable-uploads/4e803f2d-1f15-4cdd-ae19-e6c61efd3070.png", // Soul
    "/lovable-uploads/56f1d23a-6c57-4fe3-90e4-17dbac82d91b.png", // Connect
    "/lovable-uploads/0b053000-25d7-4396-8891-d05e2caf2fa0.png", // Line
    "/lovable-uploads/9e9935d1-5af0-451b-8411-5892665d7346.png", // Interface
    "/lovable-uploads/040980d6-36c8-4c96-85be-427c43ddbd76.png", // Heart
    "/lovable-uploads/be3b360f-fe9c-45f7-aa45-4caff7512c78.png", // Static wave
    // All wave slices
  ...
  const { isElementVisible } = useAnimationSequence(imagesLoaded, prefersReducedMotion);
