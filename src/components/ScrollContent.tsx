...
const ScrollContent = () => {
  ...
  useEffect(() => {
    ...
    const options = {
      root: null, // viewport
      rootMargin: "-100px", // Trigger earlier to fade out before scrolling off screen
  ...
  return (
    <div className="px-4 md:px-8 lg:px-16 pb-32 max-w-6xl mx-auto">
      ...
      <section className="mb-36">
        <QuoteCard className="section-right max-w-3xl">
          ...
          <div className="mt-6 text-base reveal-element">
...
const QuoteCard = ({ children, className = "" }) => {
  return (
    <div className={`reveal ${className}`}>
      <div className="p-6 md:p-8">
        <blockquote className="text-xl md:text-2xl italic font-playfair font-medium text-cyan-white">
          {children}
        </blockquote>
      </div>
    </div>
