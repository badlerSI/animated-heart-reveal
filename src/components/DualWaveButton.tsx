    ...
    return (
      <section className="py-20 px-4">
        ...
        >
          ...
          <Link
            to="/light"
            className="flex flex-col items-start self-start ml-6 pt-6 pb-2 px-8 mt-6 group"
          >
            <span
          ...
          <Link
            to="/heavy"
            className="flex flex-col items-end self-end mr-6 pt-2 pb-6 px-8 -mt-2 group"
          >
            <span
